      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed top-[90px] left-[40px] md:left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[400px] bg-white rounded-2xl shadow-xl z-50 overflow-hidden border border-gray-200"
          >
            <div className="p-6">
