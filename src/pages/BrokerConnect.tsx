    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="px-5 md:px-20 py-[90px] md:py-24">
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(90deg, rgba(0, 0, 0, 0.10) 0%, rgba(0, 0, 0, 0.40) 100%), url('https://api.builder.io/api/v1/image/assets/TEMP/379ac8378cc46d9bfd6b7b3471164dd9bcf5d8eb?width=2560')",
            ...
            <div className="max-w-2xl space-y-8">
              <div className="space-y-2">
                ...
                <p className="text-base text-brand-light">
                  Get personalized investment insights and real-time market data
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-start">
            ...
            <div className="flex-1 space-y-4 px-2">
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-sm text-brand-dark font-normal">
                    Investment Advisory
                  </p>
                  <p className="text-sm text-brand-dark/60">
                    Get expert guidance on building and growing your portfolio
                    with market insights and tailored investment
                    recommendations.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-brand-dark/60">
                    Access professional advice on setting up, scaling, and
                    funding your business for long-term success
                  </p>
                </div>
              </div>
      ...
      <footer className="px-5 md:px-20 py-10 space-y-6">
        <div className="flex flex-wrap justify-center items-center gap-x-24 gap-y-6">
          <a
            href="#"
            className="text-base text-brand-dark/60 hover:text-brand-dark transition-colors"
          >
            Privacy Policy
          </a>
          <a
        ...
        <div className="text-center">
          <p className="text-base text-brand-dark/60">
            © 2025 Growtt.All Right Reserved
          </p>
        </div>
      </footer>
    </div>
